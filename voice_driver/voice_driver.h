...
// This interface accompanies a Flite voice and provides well known
// functions that encapsulate most of the inner workings of Flite.
// The functions should be dlopen()/dlsym()'ed from a high-level voice
// loader.
